...
// export class AreaChart extends SwComponent {
//   state = {
//     data: [
//       { x: 1, y: 1 },
//       { x: 2, y: 2 },
...
//   render = () => (
//     <View>
//       <SwText swType='header4'>REAL TIME VISITORS</SwText>
//       <VictoryChart
//         padding={{
...
//           style={{
//               axis: { stroke: 'transparent' },
//               grid: { stroke: SwTheme.current.colors.disabled, strokeWidth: 0.5 },
//               tickLabels: {
//                 fontSize: 14,
//                 stroke: SwTheme.current.colors.text.secondary,
//                 fill: SwTheme.current.colors.text.secondary,
...
//             style={{
//                 data: {
//                   fill: SwTheme.current.colors.charts.area.fill,
//                   fillOpacity: 0.5,
//                   stroke: SwTheme.current.colors.charts.area.stroke,
//                   strokeOpacity: 0.8,
//                   strokeWidth: 1.5,
//                 },
//               }}
